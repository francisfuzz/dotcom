  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.bio}>
        <p>I'm a Senior Partner Engineer at <a href="https://github.com" target="_blank">GitHub</a>, the world's largest software development network. Previously, I worked as a program manager (and before that, a support engineer) focused on empowering customers with <a href="https://github.community/u/francisfuzz/activity/solved" target="_blank">technical advice</a> for making the most out of GitHub's platform features.</p>
        <p>I made this website to share what I know with the hope of encouraging and empowering readers (like you!). You're welcome to support <a href="https://dev.to/francisfuzz">my writing</a> by <a href="https://www.buymeacoffee.com/francisfuzz">buying me a nigiri</a>. 🍣 </p>
