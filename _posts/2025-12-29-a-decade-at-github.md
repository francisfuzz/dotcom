...
I spent time with the lead engineer, Kevi, asking basic questions the documentation didn't answer. What does this feature do? Why does it exist? I extracted my notes into a Markdown document (this was before AI tools), created a slide deck, and hosted a lunch-and-learn for support engineers.
...
When I became the ombudsperson for GitHub Actions, I published our internal support documentation in a location where product engineers could see what we were working on and what questions we were getting. Other teams working with integrators and customers building on GitHub Actions could use it too.
...
When I transitioned back to product engineering as a tech lead for GitHub documentation's build utilization work, I ramped up on modern JavaScript and build systems across vendors. I wasn't building pipelines exclusively, but translating requirements across systems taught me how to communicate well asynchronously over text without losing signal.
...
On the new user experience team, I was tasked with updating the dashboard's Copilot interface with targeted icebreakers for users who'd joined GitHub in the last month. The component was built in Rails and Catalyst JavaScript. The question: should we migrate to React to ship these new icebreakers?
...
Looking back, I wish I'd told that CEO my weapon of choice was asking great questions—but it took ten years to understand why.
...
Ten years in, I'm grateful for the questions I've asked and the people who've helped me ask better ones.
